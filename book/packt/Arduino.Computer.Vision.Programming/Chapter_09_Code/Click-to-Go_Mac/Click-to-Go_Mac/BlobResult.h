...
#ifndef __Click_to_Go__BlobResult__
#define __Click_to_Go__BlobResult__

#include <stdio.h>
/************************************************************************
 BlobResult.h
 
 FUNCIONALITAT: DefiniciÛ de la classe CBlobResult
 AUTOR: Inspecta S.L.
...
//! Excepcions llenÁades per les funcions:
#define EXCEPTION_BLOB_OUT_OF_BOUNDS	1000
#define EXCEPCIO_CALCUL_BLOBS			1001

/**
	Classe que contÈ un conjunt de blobs i permet extreure'n propietats
...
public:
    ...
    //! Retorna l'enËssim blob segons un determinat criteri
...
private:
    ...
    //! FunciÛ per gestionar els errors
...
#endif /* defined(__Click_to_Go__BlobResult__) */
